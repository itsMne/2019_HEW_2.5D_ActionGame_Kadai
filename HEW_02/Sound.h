...
typedef enum
{
	...
	SOUND_LABEL_BGM_RANKING,		// BGM0
	SOUND_LABEL_BGM_TUTORIAL,		// BGM0
	SOUND_LABEL_BGM_NORMAL,		// BGM0
	SOUND_LABEL_BGM_HELL,		// BGM0
	SOUND_LABEL_BGM_GAMEOVER,		// BGM0
	SOUND_LABEL_BGM_CLEAR,		// BGM0
	...
	SOUND_LABEL_SE_RECOVER,
	SOUND_LABEL_SE_END_REACHED,
	SOUND_LABEL_SE_SPIKES_HIT,
