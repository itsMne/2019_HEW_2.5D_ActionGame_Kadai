...
// 初期化処理
//=============================================================================
HRESULT Field3D::Init(const char* TexturePath)
{
	SetFieldLight(GetMainLight());
...
void Field3D::Draw(void)
{
	...
	// 移動を反映
	mtxTranslate = XMMatrixTranslation(Position.x/ OFFSET, Position.y/OFFSET, Position.z/ OFFSET);
...
void Field3D::SetScaleWithHitbox(float newScale)
{
	...
	hitbox.SizeX = newScale;
	hitbox.SizeZ = newScale;
}

void Field3D::SetScaleWithHitbox(XMFLOAT3 newScale)
{
	Scale = newScale;
